...
export const Whorl = () => {
    ...
    return (
      ...
      <><p>Synopsis<br></br><br></br>Music Video for WHORL by Polypores ( Preston based Musician )<br></br>
<br></br>
