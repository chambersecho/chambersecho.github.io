...
export const HandCarvedStamp = () => {
    useEffect(() => {
        document.title = 'Hand Carved Stamp - Yin';
      }, []);
    return (
      <main className="handCarvedStamp">
        <div className='title'>Hand Carved Stamp</div>
        ...
        <p className="link">Official Selection<br></br><a target="_blank" rel="noreferrer" href='https://www.newfilmmakers.com/fall-series-november-1-30/'>NewFilmmakers NY</a><br></br><a target="_blank" rel="noreferrer"href="https://liftoff.network/ft-filmmaker-sessions-2025-v10/">Lift-Off Sessions 2025 Volume 10</a></p>
