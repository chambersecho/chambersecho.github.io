...
<div >
  <br></br>They joined the Freelance Solidarity Project of the <Link className="snowyLink" to="https://nwu.org/">NWU</Link> during the <Link className="snowyLink" to="https://yinwrong.com/antielab">Hong Kong political movement</Link>, and they learned about Code of ethics,credibility, and consent; how to conduct anonymous interviews and protect sensitive sources without exploiting them, they have different aliases for media work, and all of their works in journalism are linked with one single ORCID. <br></br><br></br>
