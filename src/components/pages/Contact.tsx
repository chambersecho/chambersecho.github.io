...
When they are not working as a front-end developer on SaaS or sticking labels on envelopes as an eBay seller, they are usually watching something on Criterion Channel or reading books about race, gender, or politics. If they have more free time, they wish to make more music as <Link className="earthyLink" to="https://soundcloud.com/freelespanda">Free lesPanda</Link>, sourcing materials for Toni Morrison or Oscar Wilde related production or create a graphic novel featuring Socrates and Plato as a couple fixing problems together in a dystopian future, learn how to Macramé, and learn how to make authentic crêpes. <br></br>
            <br/>
