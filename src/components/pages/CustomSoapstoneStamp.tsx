...
export const CustomSoapstoneStamp = () => {
    ...
    <main className="custom-soapstone-stamp">
      ...
      Hand delivery available in Manchester / London on selected days only.<br/>

      For orders outside the UK, the oil-based ink pad will be replaced with a water-based ink pad due to shipping policy.<br/>
